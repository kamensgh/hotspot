# USSD APP Builder Web (React)

This is the client facing web interface that powers the USSD App Builder. Developed with Node and React.JS with <3

- [ussd-app-builder-web](#ussd-app-builder-web)
